...
const ChatbotFull = () => {
    ...
    //     const element = document.getElementsByClassName('w-full text-center px-[10px] pt-[6px] pb-[10px] m-auto text-[13px]')

    //     // Create a text node with your desired text
    //     const textNode = document.createTextNode('Your Text Here')

    //     // Append the text node to the element
    //     element.innerHTML += textNode.textContent;
    // }, [])
